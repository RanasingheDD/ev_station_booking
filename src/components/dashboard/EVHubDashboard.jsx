...
export default function EVHubDashboard() {
  return (
      ...
      <aside className="w-64 bg-[#0E1424] p-6 flex flex-col justify-between">
        <div>
          ...
          <ul className="space-y-6">
            <li className="text-green-400 font-semibold">Dashboard</li>
          ...
          <div className="w-2/3">
            ...
            <div className="flex justify-between mt-4 text-gray-400">
              <div>
                ...
                <p className="text-white font-semibold">360km/h</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-white font-semibold">Every 1mo</p>
              </div>
              <div>
